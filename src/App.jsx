  ...
  const onPointerMove=(e)=>{
    ...
    setLayers((old)=>old.map((L)=>{
      ...
      if(e.shiftKey){
        ...
        if(drag.current.axis==="x") ny=L.y; else nx=L.x;
      } else drag.current.axis=null;
      const scx=snapCenter(nx,cw/2);
      const scy=snapCenter(ny,ch/2);
      nx=scx.v; ny=scy.v; sx=scx.snap; sy=scy.snap;
